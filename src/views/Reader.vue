      ...
      <div class="read-box">
        <div class="read-content">
          ...
          <section class="read-section" :style="styleObject">
            <div class="read-inner" :style="{fontSize: userSet.fontSize+'px'}"
              ref="bookInner">
              <h3>{{title}}</h3>
    ...
    <div class="control-box" v-show="isMenu" @click="yinCang">
      ...
      <div class="footer">
        ...
        <div class="footer-catalog">
          <span @click="huanZhang('prev')">上一张</span>
          <span>目录</span>
          <span @click="huanZhang('next')">下一张</span>
        </div>
      </div>
    </div>

    <!-- <van-tabbar v-model="active">
      <van-tabbar-item name="zhui" @click="huanZhang('prev')"
        >上一章</van-tabbar-item
      >
      <van-tabbar-item name="xia" @click="huanZhang('next')"
        >下一章</van-tabbar-item
      >
    </van-tabbar> -->
  </div>
...
export default {
  ...
  methods: {
    ...
    getNewUser(){
      ...
      let localShelf = JSON.parse(window.localStorage.getItem('isNewUser')) ? JSON.parse(window.localStorage.getItem('isNewUser')) : {};
